...
const Emergency = ({ navigation }) => {
  ...
  useEffect(() => {
    (async () => {
      ...
      setAddress(`
        ${currentAddress.name}, ${currentAddress.street}, ${currentAddress.city}, ${currentAddress.region}, ${currentAddress.postalCode}
      `);
    })();
  }, []);
  ...
  return (
    <>
      <MapView
        ...
        region={region}
        showsUserLocation
        tileUrlTemplate="http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
      >
        {location && (
          <Marker
            coordinate={{
